...
var _HeyApiClient = class {
  constructor(args) {
    __publicField(this, "_client", client);
    if (args == null ? void 0 : args.client) {
...
var Project = class extends _HeyApiClient {
   ...
   */
  list(options) {
    return ((options == null ? void 0 : options.client) ?? this._client).get({
      url: "/project",
      ...options
    });
  }
...
var Config = class extends _HeyApiClient {
   ...
   */
  update(options) {
    return ((options == null ? void 0 : options.client) ?? this._client).patch({
      url: "/config",
      ...options,
      headers: {
        "Content-Type": "application/json",
...
var Session = class extends _HeyApiClient {
   ...
   */
  create(options) {
    return ((options == null ? void 0 : options.client) ?? this._client).post({
      url: "/session",
      ...options,
      headers: {
        "Content-Type": "application/json",
...
var Event = class extends _HeyApiClient {
   ...
   */
  subscribe(options) {
    return ((options == null ? void 0 : options.client) ?? this._client).get.sse({
      url: "/event",
      ...options
    });
  }
...
var OpencodeClient = class extends _HeyApiClient {
  constructor() {
    super(...arguments);
    __publicField(this, "project", new Project({ client: this._client }));
    __publicField(this, "config", new Config({ client: this._client }));
    __publicField(this, "tool", new Tool({ client: this._client }));
    __publicField(this, "path", new Path({ client: this._client }));
    __publicField(this, "session", new Session({ client: this._client }));
    __publicField(this, "command", new Command({ client: this._client }));
    __publicField(this, "find", new Find({ client: this._client }));
    __publicField(this, "file", new File({ client: this._client }));
    __publicField(this, "app", new App({ client: this._client }));
    __publicField(this, "mcp", new Mcp({ client: this._client }));
    __publicField(this, "tui", new Tui({ client: this._client }));
    __publicField(this, "auth", new Auth({ client: this._client }));
    __publicField(this, "event", new Event({ client: this._client }));
  }
  /**
...
//# sourceMappingURL=@opencode-ai_sdk_client.js.map
